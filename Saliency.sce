...
$SOA	= 144;	# Stimulus onset asynchrony (actually intertrial interval?!) for saliency proc
...
sound{wavefile {filename = "Salience/instrWavs/relax.wav";};		attenuation = .10;}	sound2_relax;
sound{wavefile {filename = "Salience/instrWavs/responsepad.wav";};attenuation = .10;}	sound3_resPad;
